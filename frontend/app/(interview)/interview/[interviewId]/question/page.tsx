...
`;
    ...
    const shouldInsertFollowUp =
      (currentFollowUpCount === 0 && JsonFeedbackResp.followUpQuestions) ||
      (JsonFeedbackResp.evaluation === "INSUFFICIENT" && JsonFeedbackResp.followUpQuestions && currentFollowUpCount < 2);
